...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _keys2.default)(filter).forEach(function (k) {
	    return _vue2.default.filter(k, filter[k]);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/vue-player.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-40579658&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./vue-player.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-40579658&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./vue-player.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	//                     <div class="info">
	//                         - <span v-text="musicData.currentTime | second2time"></span>
	//                         / <span v-text="musicData.duration | second2time"></span>
	//                     </div>
	//
	//                     <div class="progress">
	...
	//                 <li class="{{ i.title == list.now?'on':'' }}"
	//                     v-for="i in list.playlist" @click="selectPlay($index)">
	...
	exports.default = {
	    data: function data() {
	        var defaultIndex = 0,
	            ...
	            playlist = __webpack_require__(89);
	        ...
	        return {
	            ...
	            list: { now: null, playlist: playlist },
	            isPlay: false,
	            ...
	            set: function set(v) {
	                ...
	                if (isNaN(v)) {
	                    ...
	                    new _promise2.default(function (resolve) {
	                        ...
	                        _this2.audio.currentTime = v / 100 * _this2.audio.duration;
	                    });
	                }
	            }
	        },
	        bufferedEnd: function bufferedEnd() {
	            var t = (this.musicData.bufferedEnd / this.musicData.duration * 100).toFixed(2);
	            return isNaN(t) ? 0 : t;
	        },
	        lyricTransform: function lyricTransform() {
	            var v = (this.lyricLiHeight * this.lyricIndex - this.lyricLiHeight) * -1;
	            return {
	    ...
	    ready: function ready() {
	            ...
	            (0, _createClass3.default)(Control, [{
	                ...
	                value: function _bind() {
	                    ...
	                    var startHandle = function startHandle(e) {
	                        var copySlider = _this3.slider.copySlider = document.createElement('div');
	                        copySlider.className = 'slider-copy';
	                        copySlider.style.left = _this3.slider.offsetLeft + 'px';
	                        _this3.slider.parentNode.appendChild(copySlider);
	                        _this3.slider.style.display = 'none';
	                    };

	                    var moveHandle = function moveHandle(e) {
	                        e.preventDefault();
	                        var left = e.targetTouches[0].pageX,
	                            boundaryL = _this3.progress.offsetLeft,
	                            boundaryR = _this3.progress.offsetWidth + boundaryL + _this3.sliderW / 2;
	                        if (left > boundaryR) {
	                            left = boundaryR;
	                        ...
	                        _this3.slider.copySlider.stopL = left - boundaryL;
	                        _this3.slider.copySlider.style.left = _this3.slider.copySlider.stopL + 'px';
	                    };

	                    var endHandle = function endHandle() {
	                        _this3.slider.copySlider.remove();
	                        var l = _this3.slider.copySlider.stopL / _this3.progress.offsetWidth * 100;
	                        if (l > 100) l = 100;
	                        _this3.slider.style.left = l + "%";
	                        self.progress = l;
	                        _this3.slider.style.display = 'block';
	                        self.play();
	                    };

	                    var clickHandle = function clickHandle(e) {
	                        var clientX = e.clientX;
	                        var left = clientX - _this3.progress.offsetLeft;
	                        var p = left / _this3.progress.offsetWidth * 100;
	                        p = p > 100 ? 100 : p;
	                        self.progress = p;
	                        self.play();
	                    };
	        ...
	        var Lyric = self.LyricClass = function () {
	            var Lyric = function () {
	                ...
	                (0, _createClass3.default)(Lyric, [{
	                    ...
	                    value: function _load() {
	                        var name = self.getMusicName(),
	                            lyc = void 0;
	                        try {
	                            lyc = __webpack_require__(90)("./" + name + ".lrc");
	                        } catch (e) {
	                            lyc = '[00:00.00]&nbsp\n[00:00.90]纯音乐';
	                        }
	                    ...
	                    key: "_getLrc",
	                    value: function _getLrc(lyc) {
	                        return this._parseLrc(lyc);
	                    }
	                }, {
	                    key: "_renderLrc",
	                    value: function _renderLrc() {
	                        self.lyricText = this.text;
	                    }
	                }, {
	                    key: "_parseLrc",
	                    value: function _parseLrc(arr) {
	                        var lyric = arr.split('\n');
	                        var lrc = [];
	                        var lyricLen = lyric.length;
	                        for (var i = 0; i < lyricLen; i++) {
	                            var re = /\[(\d{2}):(\d{2})\.(\d{2,3})]/g;
	                            var lrcTimes = lyric[i].match(re);
	                            var lrcText = lyric[i].replace(re, '').replace(/^\s+|\s+$/g, '');
	                    ...
	                    key: "_updateLrc",
	                    value: function _updateLrc(time) {
	                        self.lyricIndex = self.Lyric._getIndex(time, self.Lyric.timeArr);
	                    }
	                }, {
	                    key: "_getIndex",
	                    value: function _getIndex(num, arr) {
	                        var numArr = [],
	                            gain = 0.35;
	                        num = num + gain;
	                        numArr.push(num);
	                        var _timeArr = numArr.concat(arr);
	                        _timeArr.sort(function (a, b) {
	                            return a - b;
	                        });
	                        var index = _timeArr.indexOf(num);
	                ...
	                value: function _drawSpectrum() {
	                    ...
	                    function drawMeter() {
	                        ...
	                        for (var i = 0; i < meterNum; i++) {
	                            var value = array[i * step] / 12;
	                            if (capYPositionArray.length < Math.round(meterNum)) {
	                                capYPositionArray.push(value);
	                            }
	                            ctx.fillStyle = fillStyle;
	                            if (value < capYPositionArray[i]) {
	                                var papH = cheight - (capYPositionArray[i] -= 0.1);
	                                if (papH < 0) papH = 0;
	    ...
	    methods: {
	        ...
	        changePlay: function changePlay(name) {
	            var _this = this;
	            var singer = this.getSinger(name);
	        ...
	        updateMusic: function updateMusic(name) {
	            this.audioSrc = this.path + name + ".mp3";
	        },
	        updateCover: function updateCover(singer) {
	            var _this = this,
	                cover = void 0,
	        ...
	        getSinger: function getSinger(musicName) {
	            var name = musicName || this.getMusicName(),
	                list = this.list.playlist,
	                index = this.searchJsonIndex(name, list);
	            return list[index]['singer'];
	        },
	        searchJsonIndex: function searchJsonIndex(value, jsonArray) {
	        ...
	        selectPlay: function selectPlay(index) {
	            var name = this.list.playlist[index].title;
	        ...
	        getMusicName: function getMusicName() {
	            var decodeSrc = decodeURIComponent(this.audioSrc);
	            return decodeSrc.replace(/.*music\/(.*)\.(.*)/ig, '$1');
	        },
	        getAllMusicName: function getAllMusicName() {
	            var list = this.list.playlist,
	                musicArray = [];
	            for (var i in list) {
	        ...
	        playingMusicIndex: function playingMusicIndex(musicArray) {
	            var arr = musicArray || this.getAllMusicName(),
	                nowMusic = this.getMusicName();
	            return arr.indexOf(nowMusic);
	        },
	        randomPlay: function randomPlay() {
	            var musicArray = this.getAllMusicName(),
	        ...
	        endedPlay: function endedPlay() {
	            var musicArray = this.getAllMusicName();
	            var index = this.playingMusicIndex(musicArray);
	            if (index !== musicArray.length - 1) {
	                this.nextPlay();
	            } else {
	        ...
	        scrollMove: function scrollMove(element, iTarget) {
	            var _this = this;
	            clearInterval(_this.scrollTimer);
	            _this.scrollTimer = setInterval(function () {
	                var speed = (iTarget - element.scrollTop) / 15;
	                speed = speed > 0 ? Math.ceil(speed) : Math.floor(speed);
	                if (element.scrollTop === iTarget) {
	                    clearInterval(_this.scrollTimer);
	                } else {
	                    var scrollSave = element.scrollTop;
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(24)(Function.call, __webpack_require__(80).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports) {
	...
	module.exports = "[00:02.39]平凡之路\n[00:03.62]演唱：朴树\n[00:05.23]作词：朴树、韩寒\n[00:07.78]作曲：朴树 \n[00:09.28]\n[00:11.78]徘徊着的 在路上的\n[00:17.37]你要走吗 via via \n[00:23.16]易碎的骄傲着\n[00:28.87]那也曾是我的模样 \n[00:34.56]沸腾着的 不安着的\n[00:40.31]你要去哪儿 via via \n[00:46.09]谜样的 沉着的\n[00:51.77]故事你真的在听吗 \n[00:56.20]我曾经跨过山河大海\n[00:59.40]也穿过人山人海 \n[01:01.82]我曾经拥有着的一切\n[01:04.88]转眼都飘散如烟 \n[01:07.71]我曾经失落 失望\n[01:09.86]失掉所有方向 \n[01:13.55]直到看见平凡才是唯一的答案 \n[01:31.85]当你仍然还在幻想\n[01:37.56]你的明天 via via \n[01:43.05]他会很暖还是很冷\n[01:48.64]对我而言是另一天 \n[01:53.29]我曾经毁了我的一切\n[01:56.40]只想永远地离开 \n[01:59.06]我曾经堕入雾的黑暗\n[02:02.15]想挣扎无法自拔 \n[02:04.87]我曾经像你像他像那野草野花 \n[02:10.76]绝望着也渴望着\n[02:13.42]也哭也笑平凡着 \n[03:24.80]我曾经跨过山河大海\n[03:28.03]也穿过人山人海 \n[03:30.47]我曾经拥有着的一切\n[03:33.55]转眼都飘散如烟 \n[03:36.24]我曾经失落 失望\n[03:38.50]失掉所有方向 \n[03:41.96]直到看见平凡才是唯一的答案 \n[03:47.76]我曾经毁了我的一切\n[03:50.95]只想永远地离开 \n[03:53.39]我曾经堕入雾的黑暗\n[03:56.39]想挣扎无法自拔 \n[03:59.04]我曾经 像你 像他\n[04:01.24]像那野草 野花 \n[04:04.71]绝望着也渴望着\n[04:07.72]也哭也笑平凡着 \n[04:10.24]我曾经跨过山河大海\n[04:13.64]也穿过人山人海 \n[04:16.11]我曾经问了整个世界\n[04:19.30]从来没得到答案 \n[04:21.89]我不过像你 像他\n[04:24.20]像那野草 野花 \n[04:27.76]冥冥中\n[04:29.37]这是我唯一要走的路啊 \n[04:34.70]时间如烟 如此这般\n[04:40.25]明天已在 yie yie \n[04:46.00]风吹过的 如云烟\n[04:51.65]你的故事讲到了哪儿 \n"

/***/ },
/* 92 */
/***/ function(module, exports) {

	module.exports = "\n\n\n\n\n<div class=\"player\" _v-40579658=\"\">\n    <audio preload=\"none\" id=\"audio\" :src=\"audioSrc\" _v-40579658=\"\"></audio>\n    <div _v-40579658=\"\">\n        <div class=\"cover\" @click=\"playPause\" _v-40579658=\"\">\n            <img :src=\"cover\" class=\"{{ isPlay ? '':'pause' }}\" _v-40579658=\"\">\n            <div class=\"play-button {{ isPlay?'bottom':'center' }}\" _v-40579658=\"\"></div>\n        </div>\n        <div class=\"right\" _v-40579658=\"\">\n            <div class=\"title\" v-text=\"list.now\" _v-40579658=\"\"></div>\n            <div class=\"lyric\" _v-40579658=\"\">\n                <ul class=\"lrc-disply\" :style=\"lyricTransform\" _v-40579658=\"\">\n                    <li v-for=\"text in lyricText\" class=\"{{ $index==lyricIndex?'weight':'' }}\" _v-40579658=\"\">{{ text[1] }}</li>\n                </ul>\n            </div>\n            <canvas height=\"25\" width=\"105\" id=\"player-canvas\" _v-40579658=\"\"></canvas>\n            <div class=\"info\" _v-40579658=\"\">\n                - <span v-text=\"musicData.currentTime | second2time\" _v-40579658=\"\"></span>\n                / <span v-text=\"musicData.duration | second2time\" _v-40579658=\"\"></span>\n            </div>\n\n            <div class=\"progress\" _v-40579658=\"\">\n                <div class=\"slider\" :style=\"{ left: progress + '%' }\" _v-40579658=\"\"></div>\n                <div v-show=\"bufferedEnd > 0\" class=\"buffered-end\" :style=\"{ width: bufferedEnd + '%' }\" _v-40579658=\"\"></div>\n            </div>\n        </div>\n    </div>\n    <ol class=\"play-list\" v-if=\"list.playlist\" _v-40579658=\"\">\n        <li class=\"{{ i.title == list.now?'on':'' }}\" v-for=\"i in list.playlist\" @click=\"selectPlay($index)\" _v-40579658=\"\">\n            <span class=\"index\" _v-40579658=\"\">{{ $index + 1 }}</span>\n            <span class=\"title\" _v-40579658=\"\">{{ i.title }}</span>\n            <span class=\"singer\" _v-40579658=\"\">{{ i.singer }}</span>\n        </li>\n    </ol>\n</div>\n";
...
/***/ function(module, exports) {
	...
	var second2time = exports.second2time = function second2time(second) {
	    var t = Math.floor(second);
